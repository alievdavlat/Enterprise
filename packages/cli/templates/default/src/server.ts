/**
 * Enterprise CMS – API-only server.
 */
import "dotenv/config";
import { EnterpriseServer } from "@enterprise/backend-express";
...
const config: EnterpriseConfig = {
  ...
  database: {
    client: (process.env.DB_CLIENT || "sqlite") as "postgres" | "mysql" | "mongodb" | "sqlite",
  ...
  api: {
    rest: { enabled: true, prefix: "/api", defaultLimit: 25, maxLimit: 200 },
    graphql: {
