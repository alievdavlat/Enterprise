...
export interface ColumnDefinition {
    name: string;
    type: "string" | "text" | "integer" | "bigint" | "float" | "decimal" | "boolean" | "date" | "datetime" | "json" | "uuid";
    nullable?: boolean;
    default?: unknown;
    unique?: boolean;
    length?: number;
 ...
 */
export declare function createDatabaseAdapter(config: DatabaseConfig): Promise<DatabaseAdapter>;
