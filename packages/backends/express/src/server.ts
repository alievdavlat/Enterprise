...
import { initSystemTables } from "./bootstrap/initSystemTables";
...
export class EnterpriseServer {
  ...
  async initialize(): Promise<void> {
    ...
    // Create / migrate all Enterprise system tables (extracted to ./bootstrap).
    await initSystemTables(this.db);
