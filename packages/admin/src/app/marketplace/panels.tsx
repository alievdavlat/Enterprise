...
import {
  Badge, Button, Card, CardContent, Input, Switch, Label,
  Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogTrigger, DialogFooter, Textarea,
} from "@enterprise/design-system";
import {
  Blocks, Settings, Layers, Clock, Repeat2, Search, ExternalLink, Filter, Plus, Check, Trash2, PlayCircle, PauseCircle,
} from "lucide-react";
...
export type Middleware = typeof MIDDLEWARES[number];
...
export function PluginsPanel({ search, filter }: { search: string; filter: string }) {
...
// ================== EXTENSIONS PANEL ==================
export function ExtensionsPanel({ search }: { search: string }) {
