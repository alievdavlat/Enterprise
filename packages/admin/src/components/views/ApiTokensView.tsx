...
import { ListSkeleton, StandardDialog } from "@/components/shared";
  ...
  return (
    <div className="p-8 space-y-6 animate-in fade-in duration-300">
      ...
      <StandardDialog
        ...
        description={
          createdToken?.accessKey
            ? "Copy the access key below. You won't be able to see it again."
        ...
        {createdToken?.accessKey ? (
          <div className="space-y-4">
            <div className="rounded-lg border border-amber-500/30 bg-amber-500/5 p-3 text-sm">
              ...
              <p className="text-muted-foreground text-xs">
                Treat the key like a password. Store it in your secrets
                manager.
              </p>
            </div>
          ...
          <form id="api-token-form" onSubmit={handleSubmit} className="space-y-4">
